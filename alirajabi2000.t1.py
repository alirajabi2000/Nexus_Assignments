# -*- coding: utf-8 -*-
"""AI–DS Nexus | A0.1. Python | RezaShokr.ipynb
...
# TODO:
celsius_t = '25'
celsius = float(celsius_t)
fahrenheit = celsius * 9/5 + 32
print(f'{celsius} daraje moadel {fahrenheit} daraje hast')
...
num2 = 4/5 #float
sum_r = num1 + num2
diffrence_r = num1 - num2
product_r = num1 * num2
true_division_r = num1 / num2
floor_division_r = num1 // num2
print('sum :', sum_r)
print('diffrence :', diffrence_r)
print('product :', product_r)
print('true_division :',true_division_r)
print('floor_division :',floor_division_r)
